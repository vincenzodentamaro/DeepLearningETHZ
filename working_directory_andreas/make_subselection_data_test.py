...
parser.add_argument("--outputdir", help='Name of the output directory', type=str, default='test_reduced')
parser.add_argument("--inputdir", help='Name of the input directory', type=str, default='test')
...
with open('./reduced_test_info.csv', 'rU') as infile:
...
with open('./removed_files.csv','a') as removed_file:
    removed_file.write("new_filename\n")
for f in files:
...
info_file = pd.read_csv('./reduced_test_info.csv')
...
info_file_removed.to_csv('./final_reduced_test_info.csv', index=False)
